...
- (void)_flash22 {
  ...
  [digit2 setNumberOnOverride];
  [digit3 setNumberOnOverride];
}
...
- (void)viewDidLayoutSubviews {
  ...
  CGSize constraintSize = CGSizeMake((self.view.bounds.size.width / 3) - 40, 70);
  CGSize sliderSize = [onOffRatioSlider_ sizeThatFits:constraintSize];
  
  phaseSlider_.frame = CGRectFramedBottomLeftInRect(self.view.bounds, sliderSize, 20, 30, YES);
